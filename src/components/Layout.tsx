...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen bg-cream flex flex-col max-w-[800px] mx-auto relative">
      {/* Header */}
      ...
      <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] bg-white/90 backdrop-blur-sm border-t border-blush/20 z-10">
        <div className="flex">
          <NavButton
